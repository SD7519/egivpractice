		...
		<table>
			...
			<tr>
				<th colspan="2">
					...
					<button type="button" onclick="location='boardModifyWrite.do?uno=${boardVO.unq}'">수정</button>
					<button type="button" onclick="location='passWrite.do?uno=${boardVO.unq}'">삭제</button>
				</th>
			</tr>
		</table>
	</form>
